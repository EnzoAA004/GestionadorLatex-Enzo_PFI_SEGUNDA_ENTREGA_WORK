...
\hline
Integración P10.9 en Frontend / cierre Full Product UI E2E &  &  &  &  &  & X & X & X &  &  \\
\hline
...
\hline
Recorrido extremo a extremo con interfaz & Se preveía cerrado para la entrega del 50 \%. & El Backend, el AI Module y la integración P10.9 en Frontend se encuentran implementados; permanece pendiente cerrar y documentar el recorrido completo con interfaz sobre el stack real. & La ampliación del alcance al visor volumétrico, la navegación por cortes y la consolidación contractual requirió priorizar la integración por capas. La integración P10.9 en Frontend se completó, mientras que el cierre y la evidencia del recorrido E2E completo se trasladan al tramo siguiente. \\
\hline
\end{longtable}
\endgroup
