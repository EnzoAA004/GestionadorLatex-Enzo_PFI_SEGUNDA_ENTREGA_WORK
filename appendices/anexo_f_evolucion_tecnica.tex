...
En una etapa posterior, la organización longitudinal dejó de depender de una referencia técnica de sujeto y se incorporó Patient como entidad de-identificada explícita. Los Studies se asocian mediante patientId, mientras que subjectRef permanece como compatibilidad opcional y no se utiliza para inferir retrospectivamente pacientes históricos.
