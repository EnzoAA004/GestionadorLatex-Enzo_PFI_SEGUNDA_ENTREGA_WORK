...
\hline
P10.9 · Consolidación & — & Congelamiento del backend y del módulo de IA para el traspaso al frontend, con recorrido técnico verificado mediante un runner automatizado. & Frontera contractual común posteriormente integrada en Frontend. & Integrado en Frontend; E2E completo pendiente de cierre \\
\hline
\end{longtable}
...
\textbf{Hecho.} La separación en tres repositorios con responsabilidades delimitadas por contrato; los modelos sagital y axial entrenados, congelados y ejecutables sobre entrada real; el runtime de inferencia con gestión de artefactos verificados por hash; la persistencia de estudios, corridas, assets y revisiones sobre PostgreSQL con migraciones versionadas; la reapertura de estudios ya procesados; la navegación por cortes con el resultado vinculado a su corte de origen; la integración P10.9 en Frontend; la incorporación de Patient como identidad longitudinal de-identificada; la asociación explícita y auditable de Studies mediante patientId; y la revisión profesional obligatoria.

\textbf{Pendiente.} El cierre y la documentación del recorrido Full Product UI E2E sobre el stack real; la validación profesional sobre el producto integrado; el despliegue objetivo; y la consolidación de la evidencia final.
...
\begin{itemize}
  ...
  \item Ingesta de estudio DICOM completo y procesamiento full-series (Backend + AI Module), línea de hallazgos degenerativos por nivel (P10.7), visor navegable e integración P10.9 en Frontend, seguida por el dominio Patient y la asociación explícita Study--Patient; el cierre Full Product UI E2E permanece pendiente.
\end{itemize}

En una etapa posterior, la organización longitudinal dejó de depender de una referencia técnica de sujeto y se incorporó Patient como entidad de-identificada explícita, con id interno UUID y patientReference como referencia seudónima de trabajo. Los Studies se asocian mediante patientId, mientras que subjectRef permanece como compatibilidad opcional y no se utiliza para inferir retrospectivamente pacientes históricos.
