...
Ejecución en nube & Se considera compatible con el flujo y útil para evitar cómputo local pesado. & Evaluarla en arquitectura, privacidad, costos, disponibilidad y seguridad. Google Cloud se planteó inicialmente en esta etapa como arquitectura objetivo y fue luego implementada y validada (Capítulo 10). \\
...
Los hallazgos se formalizan en el Capítulo 9 como requerimientos con criterio de aceptación y trazabilidad hasta su origen. Ninguna de las dos instancias constituye validación clínica. Después de este relevamiento exploratorio, se realizaron dos sesiones de revisión cualitativa del producto sobre una versión funcional/intermedia del prototipo, con la Dra. Susana Torres y la Dra. Claudia Cejas, documentadas en la sección~\ref{sec:resultados-validacion-profesional-cualitativa} y en el Anexo~\ref{anexo:validacion-profesional}. Esas sesiones tampoco constituyen validación clínica ni equivalen a la validación cruzada final, que continúa pendiente y requiere comparar lecturas profesionales independientes contra los resultados del sistema sobre los mismos estudios.
