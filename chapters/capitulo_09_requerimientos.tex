...
El cierre tecnico agrega capacidades que no modifican el principio de no diagnostico, pero si amplian la trazabilidad del prototipo: exportacion PDF/JSON, historial por \texttt{subjectRef}, comparacion longitudinal descriptiva en Demo Mode, concordance descriptiva, review analytics, feedback curation, Grad-CAM experimental, chat contextual con proveedor mock y despliegue Cloud parcial DEV. Estas capacidades se interpretan con estados diferenciados: validadas tecnicamente, parciales, experimentales, demo-only, bloqueadas o planificadas. En particular, Patient queda parcial por la diferencia entre Backend/API y Frontend visible; Cloud queda parcial por el despliegue DEV de Backend/Frontend sin AI privado ni persistencia gestionada; y las capacidades 67B2, 67C y P10.7 quedan sujetas a sus gates de paridad y validacion.
