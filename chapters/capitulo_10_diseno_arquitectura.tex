...
El principio financiero adoptado es no crear un recurso cuyo costo máximo no pueda estimarse de antemano. Esta arquitectura debe leerse por estado de madurez: Artifact Registry/WIF, Backend Cloud Run DEV y Frontend Cloud Run DEV están desplegados y validados; AI Cloud Run privado, Cloud SQL, Secret Manager, storage productivo completo, DEMO environment y monitoreo/alerting live no están desplegados y no deben presentarse como parte del estado operativo actual.


\subsection{Estado real del despliegue Cloud}

El estado Cloud final es mixto y debe documentarse por recurso, no como un bloque unico desplegado. La Tabla~\ref{tab:arch-cloud-estado-final} separa la evidencia disponible del objetivo arquitectonico pendiente.
...
Backend Cloud Run DEV & Desplegado / validado & Servicio DEV corroborado; no implica ambiente productivo ni DEMO final. \\
Frontend Cloud Run DEV & Desplegado / validado & Servicio DEV corroborado; no implica ambiente productivo ni DEMO final. \\
AI Cloud Run privado & No desplegado & El codigo de autenticacion con Google ID Token esta listo para despliegue, pero no fue ejercitado contra un servicio AI privado real. \\
Cloud SQL & No desplegado & Permanece como arquitectura objetivo para persistencia gestionada. \\
Secret Manager & No desplegado & Permanece como arquitectura objetivo para secretos fuera del codigo. \\
Storage productivo & No desplegado & Permanece como arquitectura objetivo para modelos, volumenes y assets durables. \\
