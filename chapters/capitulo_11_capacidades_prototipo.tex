...
Cómo funciona. Un estudio actúa como contenedor lógico y una corrida representa una ejecución concreta, de manera que ejecutar de nuevo no sobrescribe la evidencia anterior. Los estudios de un mismo paciente de-identificado se vinculan mediante una asociación explícita entre Study y Patient. Patient posee una referencia de-identificada visible para el flujo de trabajo, mientras que \texttt{patientId} mantiene la relación longitudinal en persistencia. El campo \texttt{subjectRef} del Study se conserva como referencia interna opcional y no sustituye esa asociación. Cada corrida genera identificadores que permiten seguirla: el del caso, el de la ejecución, el que agrupa ambos planos y el que correlaciona solicitudes y registros técnicos.
...
Visualización y navegación por cortes & 11.7 & Implementada; P10.9 integrado en frontend con catálogo full-series y visor navegable; E2E real pendiente de cierre \\
...
Persistencia, reapertura y trazabilidad & 11.9 & Implementadas; Patient es la identidad longitudinal y Study se asocia mediante \texttt{patientId} cuando corresponde \\
