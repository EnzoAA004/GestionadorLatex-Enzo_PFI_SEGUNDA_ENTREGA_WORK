...
\section{Diferencia entre instancias de validación}
\label{sec:metodologia-instancias-validacion}

El proyecto distingue cuatro instancias que cumplen objetivos distintos y no deben mezclarse. Las entrevistas EN-01 a EN-05 constituyen user research exploratorio: identificaron necesidades, riesgos, lenguaje de dominio y criterios iniciales de alcance. Las sesiones posteriores con la Dra. Susana Torres y la Dra. Claudia Cejas se clasifican como validación profesional cualitativa del prototipo: profesionales observaron y comentaron una versión funcional/intermedia del producto, con foco en utilidad, flujo, comprensión, priorización funcional y confianza. La validación técnica automatizada corresponde a pruebas de software, modelos, contratos, persistencia, seguridad, recorridos browser y despliegue. Finalmente, la validación cruzada profesional queda pendiente como etapa superior: requiere comparar la lectura independiente del profesional con el resultado del sistema sobre los mismos estudios.

La validación profesional cualitativa no se interpreta como validación clínica, diagnóstica, ensayo clínico, evaluación de performance clínica ni validación contra ground truth. Su muestra es pequeña e intencional, y sus resultados se analizan de forma narrativa. Sirve para orientar decisiones de producto y priorizar trabajo futuro; no permite estimar sensibilidad, especificidad, exactitud diagnóstica ni seguridad clínica.

\subsection{Validación profesional final pendiente}
\label{sec:metodologia-validacion-cruzada-pendiente}

La siguiente etapa de validación profesional debe realizarse con un protocolo cruzado. En primer lugar, el profesional analiza uno o más estudios de forma independiente y registra interpretación, mediciones y hallazgos relevantes. En segundo lugar, el sistema procesa los mismos estudios bajo configuración controlada. Luego se comparan niveles, segmentaciones, mediciones, hallazgos, omisiones y falsos positivos. Finalmente, el profesional revisa las diferencias, explica concordancias y discrepancias, y se documenta que parte del desacuerdo corresponde a limitaciones del sistema, variabilidad de criterio o ausencia de información clínica. Esta etapa no se realizó todavía y se presenta como el siguiente nivel de validación, no como evidencia ya obtenida.
...
Las entrevistas EN-01 a EN-05 constituyen user research exploratorio y las sesiones posteriores de producto constituyen validación profesional cualitativa sobre una versión intermedia del prototipo. Ninguna de esas instancias reemplaza una validación clínica ni una prueba de performance diagnóstica. Sus resultados se analizan de forma cualitativa y no se generalizan a toda la población profesional ni se utilizan para afirmar eficacia diagnóstica.
