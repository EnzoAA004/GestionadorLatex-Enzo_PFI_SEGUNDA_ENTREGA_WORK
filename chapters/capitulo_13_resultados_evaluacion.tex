...
Full Cloud DICOM E2E & PASS \\
Durabilidad tras restart & PASS \\
Reprocess sin re-upload & PASS \\
Persistencia final & PASS \\
Frontend $\rightarrow$ Backend Green & PASS \\
Browser Cloud E2E & PARTIAL \\
Modelo de costo & READY \\
\hline
\end{longtable}
}

Los resultados PASS corresponden a verificaciones funcionales completadas sobre la fixture descrita. El resultado PARTIAL en Browser Cloud E2E y el estado READY del modelo de costo se informan tal como fueron registrados, sin atribuirles una causa que no esté documentada en la evidencia disponible.
