...
Cloud DICOM E2E sobre fixture sintética & PASS & Carga, procesamiento y persistencia de la fixture DICOM sintética de punta a punta sobre los servicios Cloud. \\
...
Modelo de costo observado en el escenario sintético & Listo & Construido sobre mediciones reales tomadas sobre la fixture sintética (ver Tabla~\ref{tab:res-cloud-costos-performance}), no sobre estimaciones teóricas ni sobre costo de operación clínica. \\
...
El detalle ampliado de las sesiones VP-01 y VP-02, su metodología, la trazabilidad hacia decisiones de producto y las limitaciones de esta instancia se documentan en el Anexo~\ref{anexo:validacion-profesional}.
...
\begin{enumerate}
    ...
    \item El despliegue Cloud DEV (Backend, Frontend, AI Cloud Run privado, Cloud SQL, Secret Manager y storage durable) está desplegado y validado según la evidencia de la sección~\ref{sec:resultados-cloud-e2e}; el entorno DEMO separado y el monitoreo/alerting en vivo no fueron desplegados.
