...
\caption{Estado consolidado de entregables y actividades de cierre del proyecto.}\label{tab:plan-roadmap-50}\\
\hline
...
\hline
Documentación del 100 \% & en integración & documento maestro, capítulos revisados, matrices y diagramas. \\
\hline
Google Cloud & cerrado técnicamente / validado & Artifact Registry/WIF, Backend Cloud Run DEV y Frontend Cloud Run DEV desplegados; AI privado, Cloud SQL, Secret Manager, storage productivo, DEMO environment y monitoring live pendientes. \\
\hline
Validación profesional sobre producto & revisión cualitativa realizada; validación cruzada final pendiente & dos sesiones sobre versión funcional/intermedia; observaciones y ajustes priorizados; no equivale a validación clínica ni cruzada. \\
\hline
...
\hline
P10.7 hallazgos degenerativos asistivos por nivel & implementado pero bloqueado para inferencia productiva automática & checkpoint y contratos existen; \texttt{blocked\_preprocessing\_parity} y \texttt{automaticInferenceEnabled=false}; no se presenta como productivo. \\
\hline
...
\hline
Recorrido Full Product UI E2E sobre stack real & validado funcionalmente & Playwright final 11/11 PASS sobre el recorrido demo/producto; no equivale a validación clínica ni a Patient browser-level completo. \\
\hline
\end{longtable}
\endgroup
