...
% \newpage
El \'{i}ndice desarrolla hasta tres niveles de titulaci\'on, dentro del m\'aximo de cuatro admitido por la c\'atedra.
...
\input{chapters/capitulo_06_estado_del_arte}
\input{chapters/capitulo_07_marco_teorico}
\input{chapters/capitulo_08_user_research}
\input{chapters/capitulo_09_requerimientos}
\input{chapters/capitulo_10_diseno_arquitectura}
\input{chapters/capitulo_11_capacidades_prototipo}
\input{chapters/capitulo_12_metodologia_validacion}
\input{chapters/capitulo_13_resultados_evaluacion}
\input{chapters/capitulo_14_planificacion_academica}

\appendix
\input{appendices/anexo_a_cronograma}
\input{appendices/anexo_b_glosario}
\input{appendices/anexo_c_anatomia}
\input{appendices/anexo_d_entrevistas}
\input{appendices/anexo_e_configuracion_entrenamiento}
\input{appendices/anexo_f_evolucion_tecnica}
\input{appendices/anexo_g_adr}

\nocite{kirillov_panoptic_2019,kruchten_4plus1_1995,pfirrmann_disc_degeneration_2001}
