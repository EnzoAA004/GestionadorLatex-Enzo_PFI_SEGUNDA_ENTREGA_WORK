...
\caption{Diagrama de contexto del sistema. Fuente: elaboraci?n propia.}
\label{fig:arch-contexto-sistema}
\end{figure}
% STRUCTURE_REVIEW_REQUIRED
% SOURCE_NUMBERING_GAP: 10.2
% DOCX_INLINE_TEXT_AFTER_CAPTION: 10.2 Visi?n general del flujo
% STRUCTURE_REVIEW_REQUIRED
% SOURCE_NUMBERING_GAP: 10.2
...
\caption{Arquitectura general por componentes. Fuente: elaboraci?n propia.}
\label{fig:arch-componentes}
\end{figure}
% STRUCTURE_REVIEW_REQUIRED
% DOCX_INLINE_TEXT_AFTER_CAPTION: 10.3.2 Arquitectura volum?trica y visualizaci?n de secciones.
% STRUCTURE_REVIEW_REQUIRED
...
\caption{Arquitectura del visor volum?trico. Fuente: elaboraci?n propia.}
...
\caption{Modelo de datos relacional (PostgreSQL). Fuente: elaboraci?n propia.}
...
\caption{Diagrama de clases del dominio y servicios. Fuente: elaboraci?n propia.}
...
\caption{Flujo de interacci?n end-to-end. Fuente: elaboraci?n propia.}
...
\caption{Arquitectura objetivo de despliegue en Google Cloud. Fuente: elaboraci?n propia.}
