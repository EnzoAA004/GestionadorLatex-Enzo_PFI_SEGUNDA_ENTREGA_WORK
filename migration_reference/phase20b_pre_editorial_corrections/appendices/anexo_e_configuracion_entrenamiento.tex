...
% SOURCE_NUMBERING_ANOMALY_PRESERVED: F.3 literal in DOCX Heading2
\phantomsection
\section*{F.3 Controles de calidad al cierre del entrenamiento}
\addcontentsline{toc}{section}{F.3 Controles de calidad al cierre del entrenamiento}
...
% SOURCE_NUMBERING_ANOMALY_PRESERVED: F.4 literal in DOCX Heading2
\phantomsection
\section*{F.4 Trazabilidad de los artifacts}
\addcontentsline{toc}{section}{F.4 Trazabilidad de los artifacts}
