...
La Tabla 8.1 resume los conceptos desarrollados y su vinculación con el prototipo.
% CROSS_REFERENCE_MAPPING_REQUIRED
% CROSS_REFERENCE_NUMBERING_REVIEW_REQUIRED

% TABLE_PENDING_MIGRATION
% DOCX_TABLE_NUMBER: Tabla 7.1
% DOCX_TABLE_TITLE: Síntesis del marco teórico y vinculación con el PFI.
