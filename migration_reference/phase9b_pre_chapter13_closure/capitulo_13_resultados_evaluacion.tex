\chapter{13. Resultados de la evaluación técnica}
...
% DOCX_TABLE_NUMBER: 13.1
% DOCX_TABLE_TITLE: Partición de los conjuntos de datos empleados en el entrenamiento y la evaluación.
% TABLE_ROLE: OTHER
% TABLE_ROWS: 3
% TABLE_COLUMNS: 5
...
% TABLE_PENDING_MIGRATION
% DOCX_TABLE_NUMBER: 13.2
% DOCX_TABLE_TITLE: Coeficiente Dice sobre la partición retenida, por modelo.
% TABLE_ROLE: SEGMENTATION_RESULTS
% TABLE_ROWS: 4
% TABLE_COLUMNS: 5
% TABLE_MERGED_CELLS: NO
% TABLE_COMPLEXITY: MEDIUM
...
% TABLE_PENDING_MIGRATION
% DOCX_TABLE_NUMBER: 13.3
% DOCX_TABLE_TITLE: Verificación por contraste de las mediciones sobre el estudio de referencia.
% TABLE_ROLE: MEASUREMENT_RESULTS
% TABLE_ROWS: 4
% TABLE_COLUMNS: 4
% TABLE_MERGED_CELLS: NO
% TABLE_COMPLEXITY: MEDIUM
